...
export default async function Project() {
  ...
  return (
    <main className="max-w-7xl mx-auto md:px-16 px-6">
      <PageHeading
        title="Projects"
        description="I've worked on tons of little projects over the years. Due to agreements with clients, I can't show you all of them here. But you can see some of them below."
      />
